            ...
            <div className="px-4 mb-12">
                ...
                <div className="flex gap-6 overflow-x-auto no-scrollbar">
                    {Array(8).fill(0).map((_, i) => (
                        <div key={i} className="w-56 h-80 rounded-xl bg-white/10 animate-pulse" />
                    ))}
                </div>
            </div>
        );
    ...
    return (
        <section className="mb-14 px-4 relative w-full overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-5">
                <FaFireAlt className="text-red-500 text-3xl animate-pulse" />
                    ...
                    <div key={movie._id} className="relative">
                        <span
                            className="
                                ...
                                bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-lg z-30
                            "
                        >
                            🔥 Trending
                        </span>
